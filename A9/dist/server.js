...
var uri = "mongodb+srv://keelan:myPassword@dbexample.f5fn5u8.mongodb.net/?retryWrites=true&w=majority";
...
function _getClasses() {
  _getClasses = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var database, collection, options, cursor, results;
